          ...
          <div className="flex flex-col md:grid grid-cols-12 text-gray-50">
            ...
            {/* <div className="flex md:contents">
              ...
              <div className="bg-green-500 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
                <h3 className="font-semibold text-lg mb-1">Graduated at the Hong Kong Polytechnic University</h3>
            ...
            {/* <div className="flex md:contents">
              ...
              <div className="bg-green-500 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
                <h3 className="font-semibold text-lg mb-1">Technician</h3>
            ...
            {/* <div className="flex md:contents">
              ...
              <div className="bg-green-500 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
                <h3 className="font-semibold text-lg mb-1">Research Assistant</h3>
                <p className="leading-tight text-justify">
                  2014
                </p>
              </div>
            ...
            {/* <div className="flex md:contents">
              ...
              <div className="bg-green-500 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
                <h3 className="font-semibold text-lg mb-1">Assistant Engineer</h3>
                <p className="leading-tight text-justify">
                  2015
                </p>
              </div>
